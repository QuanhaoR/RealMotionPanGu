...
class RealMotion_pangu_I(nn.Module):
    def __init__(
        ...
        self.pangu_linear_before = nn.Linear(embed_dim,1536,bias = False)
        ...
        self.pangu_linear_after = nn.Linear(1536,embed_dim,bias = False)
    ...
    def forward(self, data):
        ...
        x_encoder = self.pangu_linear_before(x_encoder)
        x_encoder = self.pangu(x_encoder,key_padding_mask=~key_valid_mask)
        x_encoder = self.pangu_linear_after(x_encoder)
